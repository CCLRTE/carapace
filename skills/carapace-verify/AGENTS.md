...
- `SKILL.md` – evidence discovery, deterministic settlement, semantic verification, and proof classification workflow.
- `agents/openai.yaml` – concise UI metadata and default `$carapace-verify` invocation.
